class Rake < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rustyhorde/cargo-rake/releases/download/v0.3.0/rake-aarch64-apple-darwin.tar.gz"
      sha256 "29925bca22dca1f8bafc06e36393169f00a30235bb33e24ebde788cfc9342a51"
    end
  end
