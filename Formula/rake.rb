class Rake < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rustyhorde/cargo-rake/releases/download/v0.4.2/rake-aarch64-apple-darwin.tar.gz"
      sha256 "9d75cb28d090aba7c3d7648728d943a6fb1e800cf5b6cd2f615271eb7e2a6694"
    end
  end
